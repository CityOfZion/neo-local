...
neo> sc build_run /smart-contracts/4-domain.py True False False 0710 05 query ["test.com"]
neo> sc build_run /smart-contracts/4-domain.py True False False 0710 05 register ["test.com","AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"]
neo> sc build_run /smart-contracts/4-domain.py True False False 0710 05 delete ["test.com"]
neo> sc build_run /smart-contracts/4-domain.py True False False 0710 05 transfer ["test.com","AK2nJJpJr6o664CWJKi1QRXjqeic"]

Importing:

neo> sc deploy /smart-contracts/4-domain.avm True False False 0710 05
neo> search contract ...
